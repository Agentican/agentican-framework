...
public record WorkflowStepAgent(
        String name,
        String agentName,
        String instructions,
        ...
        ConditionMode conditionMode) implements WorkflowStep {

    public WorkflowStepAgent {
    ...
    public WorkflowStepAgent(String name, String agentName, String instructions, List<String> dependencies,
                         boolean hitl, List<String> skills, List<String> tools) {

        this(name, agentName, instructions, dependencies, hitl, skills, tools, 0, null, null, null);
    }
    ...
    public WorkflowStepAgent(String name, String agentName, String instructions, List<String> dependencies,
        ...
        this(name, agentName, instructions, dependencies, hitl, skills, tools,
    ...
    public static class Builder {
        ...
        public WorkflowStepAgent build() {

            return new WorkflowStepAgent(name, agentName, instructions, dependencies, hitl, skills, tools,
