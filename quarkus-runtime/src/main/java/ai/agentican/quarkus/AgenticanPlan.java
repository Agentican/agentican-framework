...
/**
 * Qualifier for injecting a typed {@link ai.agentican.framework.Agentican}
 * bound to a plan by <b>name</b>.
 *
 * <pre>
 * &#64;Inject &#64;AgenticanPlan("triage")
 * Agentican&lt;TriageParams&gt; triage;
 * </pre>
 *
 * <p>The plan is resolved from {@code AgenticanRuntime.registry().plans()} on each
