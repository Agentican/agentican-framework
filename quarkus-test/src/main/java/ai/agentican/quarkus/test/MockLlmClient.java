...
public class MockLlmClient implements LlmClient {
    ...
    public MockLlmClient queueEndTurn(String text) {
        ...
        responses.add(new LlmResponse(text, List.of(), StopReason.END_TURN, 100, 50, 10, 5, 0));
        return this;
    }
    ...
    public MockLlmClient queueToolCall(String callId, String toolName, Map<String, Object> args) {
        ...
        responses.add(new LlmResponse("", List.of(toolCall), StopReason.TOOL_USE, 100, 50, 0, 0, 0));
        return this;
    }
    ...
    public LlmResponse send(LlmRequest request) {
        ...
        if (response == null)
            return new LlmResponse("[mock: no queued response]", List.of(), StopReason.END_TURN, 10, 10, 0, 0, 0);
